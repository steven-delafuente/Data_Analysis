...
```{r}
data <- read.csv(file= "/Users/Steve/Dropbox/ucsc/data_analysis/project/Fire_Department_Calls_for_Service_2016.csv")
```
...
```{r}
sfn_shp <- st_read('/Users/steve/Downloads/sf_nhoods/geo_export_b43d0be8-0ef5-421a-8fa0-204489a90d6b.shp')
```
